...
INSERT INTO militar 
(  id_militar, nome_completo, nome_guerra, numero, fk_id_posto_grad, fk_id_arma, tu_formacao,  fk_id_escola_formacao, fk_id_sit_militar, fk_id_sit_servico, cpf,
  idt_mil, data_apresentacao,  data_desligamento)
VALUES 
...
SET  fk_id_posto_grad = 
    ...
    END
WHERE fk_id_posto_grad BETWEEN 1 AND 12;
